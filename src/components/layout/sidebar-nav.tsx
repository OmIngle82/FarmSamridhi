...
export function SidebarNav() {
  ...
  const getNavItems = () => {
    if (pathname.startsWith("/farmer")) return farmerNav
    if (pathname.startsWith("/distributor")) return distributorNav
    if (pathname.startsWith("/retailer")) return retailerNav
    if (pathname.startsWith("/consumer")) return consumerNav
    return []
  }
